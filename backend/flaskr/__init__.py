...
#This function will paginate the questions ,ten per page 
...
def create_app(test_config=None):
    ...
    def get_questions():
        ...
        paginated_questions =paginate_question(request,selection)
    ...
    def retrieve_questionsByCategory(category_id):
